    ...
    defaultValues: {
      ...
      ...(options ?? {
        ...
        evaluations: [
          {
            name: "Politeness",
            description: "Measure of how polite the user message is",
            value: "1-100: 1 is very rude and 100 being super nice.",
            type: "message",
          },
          {
            name: "Address",
            description: "Measure whether the user asked for the address",
            value: "1-100: 1 is no address and 100 is a full address is given",
            type: "session",
          },
          {
            name: "Age",
            description: "Did the user ask about the age of the caller",
                ...
                <field.TextAreaField
                  ...
                  onKeyDown={(e) => {
                    if (e.key === "Enter" && !e.shiftKey) {
                      e.preventDefault();
                      if (status === "ready") form.handleSubmit();
                    }
                  }}
                />
              )}
          ...
          <Dialog>
            ...
            <DialogContent className="flex flex-col gap-4 py-4">
              <DialogHeader>
                ...
                <DialogDescription>
                  Customize the scenario for the AI, including the persona,
        ...
        {reversedMessages.map((m) => {
          ...
          return (
            <div key={m.id} className="self-start flex-col flex gap-2">
              <p className="whitespace-pre-line">{json?.content}</p>
